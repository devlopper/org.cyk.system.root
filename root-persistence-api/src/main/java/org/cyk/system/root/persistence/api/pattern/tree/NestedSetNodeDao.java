...
public interface NestedSetNodeDao extends TypedDao<NestedSetNode> , Serializable {
	...
	Long countDirectChildrenByParent(NestedSetNode parent);
	...
	Collection<NestedSetNode> readWhereParentIsNullBySet(NestedSet set);
	Long countWhereParentIsNullBySet(NestedSet set);
