...
public interface MailBusiness extends MessageSendingBusiness<InternetAddress> {
	...
	void send(Message message,Collection<ElectronicMailAddress> electronicMails,SmtpProperties smtpProperties);
	void send(Message message,Collection<ElectronicMailAddress> electronicMails);
