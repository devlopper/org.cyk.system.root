...
public interface BusinessLayerListener {
	...
	public static class Adapter extends AbstractBean implements Serializable, BusinessLayerListener {
		...
		//@Override public void beforeInstall(BusinessLayer businessLayer, Installation installation) {}

		//@Override public void afterInstall(BusinessLayer businessLayer, Installation installation) {}
