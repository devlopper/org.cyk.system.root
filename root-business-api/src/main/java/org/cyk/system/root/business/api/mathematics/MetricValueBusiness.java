...
public interface MetricValueBusiness extends TypedBusiness<MetricValue> {
	...
	Collection<MetricValue> findByMetricCollectionByMetricByIdentifiable(String metricCollectionCode,String metricRelativeCode,AbstractIdentifiable identifiable);
	...
	void derive(Collection<MetricValue> metricValues,Derive derive);
