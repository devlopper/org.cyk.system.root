...
public class NestedSetBusinessITOLD extends AbstractBusinessIT {
	...
	private void createAll(){
			...
			setA = new NestedSet();
			testCase.create(a = new NestedSetNode(setA,null));
			...
			*/
			...
			setB = new NestedSet();
			testCase.create(b = new NestedSetNode(setB,null));
    ...
    private NestedSetNode createChild(NestedSetNode parent){
		return create(new NestedSetNode(parent.getSet(), nestedSetNodeBusiness.find(parent.getIdentifier())));
	}
    @SuppressWarnings("unused")
    private NestedSetNode delete(NestedSetNode node){
		return delete(nestedSetNodeBusiness.find(node.getIdentifier()));
	}
