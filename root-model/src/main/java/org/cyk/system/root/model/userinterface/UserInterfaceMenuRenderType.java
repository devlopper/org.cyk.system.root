...
public class UserInterfaceMenuRenderType extends AbstractEnumeration implements Serializable {

	private static final long serialVersionUID = 5908328682512231058L;

	public UserInterfaceMenuRenderType(String code,String name) {
