...
public class Instant extends AbstractModelElement implements Serializable {
	...
	@Column(name=COLUMN_WEEK_DAY_INDEX)			private Byte weekDayIndex;
	...
	public static final String FIELD_WEEK_DAY_INDEX = "weekDayIndex";
	...
	public static final String COLUMN_WEEK_DAY_INDEX = COLUMN_PREFIX+FIELD_WEEK_DAY_INDEX;
}
