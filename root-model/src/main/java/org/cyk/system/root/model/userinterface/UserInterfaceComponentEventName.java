...
public class UserInterfaceComponentEventName extends AbstractEnumeration implements Serializable {

	private static final long serialVersionUID = 5908328682512231058L;

	public UserInterfaceComponentEventName(String code,String name) {
