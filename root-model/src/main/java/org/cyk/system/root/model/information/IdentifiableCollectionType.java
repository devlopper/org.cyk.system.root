...
public class IdentifiableCollectionType extends AbstractEnumeration implements Serializable {
	
	private static final long serialVersionUID = -4946585596435850782L;

	public IdentifiableCollectionType(String code, String libelle) {
